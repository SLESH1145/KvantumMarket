Iron Web Scraper
===========================================
Iron Web Scraper is web scraping library for C#.   It allows developers to simulate and automate human browsing behavior in order to extract content, files and image content from web applications as native .Net objects.
...
Getting Installed
===========================================
- Requires: .Net Framework 4.5.2, .Net Core 2.1, .Net Standard 2.0 or . NET 5
...
===========================================
- The webscraper runs Init first.  This lets you set any properties elegantly, and also add our staring page using:  
